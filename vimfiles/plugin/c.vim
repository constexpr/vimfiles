  ...
  " ==========  MS Windows  ======================================================
	...
	if match(	substitute( expand("<sfile>"), '\', '/', 'g' ), 
		...
		let s:C_ToolboxDir				 += [
					...
					\	$VIM.'/vimfiles/autoload/mmtoolbox/' ]
	endif
	"
  let s:C_FilenameEscChar 			= ''
	"
...
let s:C_IndentErrorLog				= $VIM.'/.indent.errorlog'
"
...
"
call s:C_SetGlobalVariable ( 'C_CFlags', '-Wall -g -O0 -c -std=c99')
call s:C_SetGlobalVariable ( 'C_LFlags', '-Wall -g -O0'   )
call s:C_SetGlobalVariable ( 'C_Libs',   '-lm'            )
"
call s:C_SetGlobalVariable ( 'C_CplusCFlags', '-Wall -g -O0 -c -std=c++11')
...
call s:C_SetGlobalVariable ( 'C_UseTool_cmake',   'yes' )
call s:C_SetGlobalVariable ( 'C_UseTool_doxygen', 'yes' )
